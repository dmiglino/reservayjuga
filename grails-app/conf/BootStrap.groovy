...
//	List precios = [l1,l2,l3,l4,m1,m2,m3,m4,mi1,mi2,mi3,mi4,j1,j2,j3,j4,v1,v2,v3,v4,s1,s2,s3,s4,d1,d2,d3,d4]
	...
	def crearCancha() {
		...
		p4 = new Cancha(nombre:"Poli-4", deporte:DeporteEnum.FUTBOL_7, superficie: SuperficieEnum.PARQUET, cantidadJugadores:7, cubierta: true,precios:precios, complejo:poli)
		p5 = new Cancha(nombre:"Poli-5", deporte:DeporteEnum.FUTBOL_7, superficie: SuperficieEnum.SINTETICO_CON_ARENA, cantidadJugadores:7, cubierta: false,precios:precios, complejo:poli)
		p6 = new Cancha(nombre:"Poli-6", deporte:DeporteEnum.FUTBOL_8, superficie: SuperficieEnum.SINTETICO_CON_CAUCHO, cantidadJugadores:8, cubierta: false,precios:precios, complejo:poli)
		...
		muni4 = new Cancha(nombre:"Muni-4", deporte:DeporteEnum.FUTBOL_8, superficie: SuperficieEnum.SINTETICO_CON_ARENA, cantidadJugadores:8, cubierta: true,precios:precios, complejo:muni)
...
//		DBUtils.validateAndSave([l1,l2,l3,l4,m1,m2,m3,m4,mi1,mi2,mi3,mi4,j1,j2,j3,j4,v1,v2,v3,v4,s1,s2,s3,s4,d1,d2,d3,d4])
	...
	def crearJugadores() {
		...
		if(!user) {
			...
			user = new Jugador(apellido: "Escamez",nombre: "Tomas",username:"jugadorTom",password:"jugador",enable:true, telefono:"12345678", mail:"t@e.com", sexo:"M", dni:33333333, fechaNacimiento: fecha )
		}
		...
		if(!user) {
			...
			cal.set(1984, 4-1, 12)
			Date fecha = cal.getTime()
			user = new Jugador(apellido: "Miglino",nombre: "Diego",username:"jugadorDie",password:"jugador",enable:true, telefono:"12345678", mail:"d@m.com", sexo:"M", dni:30303030, fechaNacimiento: fecha )
		}
		DBUtils.validateAndSave(user)
		SecUserSecRole.create(user,role,true)
		
		user = SecUser.findByUsername("jugadorMartin")
		if(!user) {
			Calendar cal = Calendar.getInstance()
			cal.set(1984, 4-1, 12)
			Date fecha = cal.getTime()
			user = new Jugador(apellido: "Otero",nombre: "Martin",username:"jugadorMartin",password:"jugador",enable:true, telefono:"12345678", mail:"m@o.com", sexo:"M", dni:20202020, fechaNacimiento: fecha )
		}
		DBUtils.validateAndSave(user)
		SecUserSecRole.create(user,role,true)
		
		user = SecUser.findByUsername("jugadorAriel")
		if(!user) {
			Calendar cal = Calendar.getInstance()
			cal.set(1984, 4-1, 12)
			Date fecha = cal.getTime()
			user = new Jugador(apellido: "Besomi",nombre: "Ariel",username:"jugadorAriel",password:"jugador",enable:true, telefono:"12345678", mail:"a@b.com", sexo:"M", dni:35555030, fechaNacimiento: fecha )
		}
		DBUtils.validateAndSave(user)
		SecUserSecRole.create(user,role,true)
	}
	...
	def crearReservas() {
		Jugador jugDie = Jugador.findByNombre("Diego")
		Jugador jugTom = Jugador.findByNombre("Tomas")
		Jugador jugMartin = Jugador.findByNombre("Martin")
		Jugador jugAriel = Jugador.findByNombre("Ariel")
		Calendar cal = Calendar.getInstance()
		...
		Reserva reserva1conc  = new Reserva(horaInicio: "10:00", horaFin: "11:00", tipoReserva:TipoReservaEnum.ONLINE, precioTotal:350, senia:350, dia:fecha, cancha: p2, complejo: poli, jugador: jugDie, estado: ReservaEnum.CONCRETADA)
		Reserva reserva2  = new Reserva(horaInicio: "13:00", horaFin: "14:00", tipoReserva:TipoReservaEnum.PRESENCIAL, precioTotal:450, senia:450, dia:fecha, cancha: p3, complejo: poli, jugador: jugMartin, estado: ReservaEnum.CONCRETADA)
		Reserva reserva2pend  = new Reserva(horaInicio: "13:00", horaFin: "14:00", tipoReserva:TipoReservaEnum.PRESENCIAL, precioTotal:450, senia:75, dia:fecha, cancha: p2, complejo: poli, jugador: jugMartin, estado: ReservaEnum.PENDIENTE)
		Reserva reserva3  = new Reserva(horaInicio: "14:00", horaFin: "15:00", tipoReserva:TipoReservaEnum.ONLINE, precioTotal:500, senia:500, dia:fecha, cancha: p2, complejo: poli, jugador: jugMartin, estado: ReservaEnum.CONCRETADA)
		Reserva reserva4  = new Reserva(horaInicio: "16:00", horaFin: "17:00", tipoReserva:TipoReservaEnum.PRESENCIAL, precioTotal:375, senia:150, dia:fecha, cancha: p4, complejo: poli, jugador: jugAriel, estado: ReservaEnum.SENIADA)
		Reserva reserva5  = new Reserva(horaInicio: "17:00", horaFin: "18:00", tipoReserva:TipoReservaEnum.ONLINE, precioTotal:475, senia:50, dia:fecha, cancha: p1, complejo: poli, jugador: jugAriel, estado: ReservaEnum.SENIADA)
		Reserva reserva6  = new Reserva(horaInicio: "22:00", horaFin: "23:00", tipoReserva:TipoReservaEnum.ONLINE, precioTotal:400, senia:125, dia:fecha, cancha: p1, complejo: poli, jugador: jugAriel, estado: ReservaEnum.PENDIENTE)
		Reserva reserva7  = new Reserva(horaInicio: "21:00", horaFin: "22:00", tipoReserva:TipoReservaEnum.PRESENCIAL, precioTotal:425, senia:425, dia:fecha, cancha: p3, complejo: poli, jugador: jugTom, estado: ReservaEnum.CONCRETADA)
		Reserva reserva7conc  = new Reserva(horaInicio: "21:00", horaFin: "22:00", tipoReserva:TipoReservaEnum.PRESENCIAL, precioTotal:425, senia:425, dia:fecha, cancha: p5, complejo: poli, jugador: jugTom, estado: ReservaEnum.CONCRETADA)
		...
		Reserva reservaPoliHorarioLleno1  = new Reserva(horaInicio: "18:00", horaFin: "19:00", tipoReserva:TipoReservaEnum.ONLINE, precioTotal:550, senia:550, dia:fecha, cancha: p1, complejo: poli, jugador: jugDie, estado: ReservaEnum.CONCRETADA)
		Reserva reservaPoliHorarioLleno2  = new Reserva(horaInicio: "18:00", horaFin: "19:00", tipoReserva:TipoReservaEnum.ONLINE, precioTotal:550, senia:100, dia:fecha, cancha: p2, complejo: poli, jugador: jugDie, estado: ReservaEnum.SENIADA)
		...
		Reserva reservaPoliHorarioLleno4  = new Reserva(horaInicio: "18:00", horaFin: "19:00", tipoReserva:TipoReservaEnum.ONLINE, precioTotal:700, senia:700, dia:fecha, cancha: p4, complejo: poli, jugador: jugMartin, estado: ReservaEnum.CONCRETADA)
		Reserva reservaPoliHorarioLleno5  = new Reserva(horaInicio: "18:00", horaFin: "19:00", tipoReserva:TipoReservaEnum.ONLINE, precioTotal:700, senia:700, dia:fecha, cancha: p5, complejo: poli, jugador: jugMartin, estado: ReservaEnum.CONCRETADA)
		Reserva reservaPoliHorarioLleno6  = new Reserva(horaInicio: "18:00", horaFin: "19:00", tipoReserva:TipoReservaEnum.ONLINE, precioTotal:800, senia:150, dia:fecha, cancha: p6, complejo: poli, jugador: jugMartin, estado: ReservaEnum.SENIADA)
		Reserva reservaPoliHorarioLleno7  = new Reserva(horaInicio: "18:00", horaFin: "19:00", tipoReserva:TipoReservaEnum.ONLINE, precioTotal:1100, senia:1100, dia:fecha, cancha: p7, complejo: poli, jugador: jugDie, estado: ReservaEnum.CONCRETADA)
		
		Reserva reservaPoliHorarioLleno11  = new Reserva(horaInicio: "11:00", horaFin: "12:00", tipoReserva:TipoReservaEnum.ONLINE, precioTotal:450, senia:100, dia:fecha, cancha: p1, complejo: poli, jugador: jugMartin, estado: ReservaEnum.SENIADA)
		Reserva reservaPoliHorarioLleno12  = new Reserva(horaInicio: "11:00", horaFin: "12:00", tipoReserva:TipoReservaEnum.ONLINE, precioTotal:450, senia:100, dia:fecha, cancha: p2, complejo: poli, jugador: jugMartin, estado: ReservaEnum.SENIADA)
		Reserva reservaPoliHorarioLleno13  = new Reserva(horaInicio: "11:00", horaFin: "12:00", tipoReserva:TipoReservaEnum.ONLINE, precioTotal:450, senia:450, dia:fecha, cancha: p3, complejo: poli, jugador: jugMartin, estado: ReservaEnum.CONCRETADA)
		Reserva reservaPoliHorarioLleno14  = new Reserva(horaInicio: "11:00", horaFin: "12:00", tipoReserva:TipoReservaEnum.ONLINE, precioTotal:650, senia:600, dia:fecha, cancha: p4, complejo: poli, jugador: jugAriel, estado: ReservaEnum.CONCRETADA)
		...
		Reserva reservaPoliHorarioLleno16  = new Reserva(horaInicio: "11:00", horaFin: "12:00", tipoReserva:TipoReservaEnum.ONLINE, precioTotal:700, senia:150, dia:fecha, cancha: p6, complejo: poli, jugador: jugAriel, estado: ReservaEnum.SENIADA)
		...
		Reserva reserva9 = new Reserva(horaInicio: "11:00", horaFin: "12:00", tipoReserva:TipoReservaEnum.PRESENCIAL, precioTotal:400, senia:400, dia:fecha, cancha: t2, complejo: terraza, jugador: jugTom, estado: ReservaEnum.CONCRETADA)
		Reserva reserva10 = new Reserva(horaInicio: "12:00", horaFin: "13:00", tipoReserva:TipoReservaEnum.ONLINE, precioTotal:350, senia:90, dia:fecha, cancha: muni1, complejo: muni, jugador: jugAriel, estado: ReservaEnum.SENIADA)
		Reserva reserva11 = new Reserva(horaInicio: "09:00", horaFin: "10:00", tipoReserva:TipoReservaEnum.PRESENCIAL, precioTotal:450, senia:450, dia:fecha, cancha: muni2, complejo: muni, jugador: jugAriel, estado: ReservaEnum.CONCRETADA)
