...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title><g:message code="login.titulo.label" default="Sistema Reserva y Juga" /></title>
											...
											<form action='${postUrl}' method='POST' id='loginForm' class='cssform' autocomplete='off'>
												<fieldset>
													...
													<div class="clearfix">
														...
														<button type='submit' id="submit" class='width-35 pull-right btn btn-sm btn-primary' value='${message(code: "springSecurity.login.button")}'>
															<i class="icon-key"></i>
